    ...
    <div className="res-kiosk-container">
      <nav className="res-step-indicator">
        {steps.map((step, index) => (
          <div
            key={step.id}
            className={`res-step-item ${step.completed ? "res-completed" : "res-pending"}`}
          >
            ...
            <div className="res-step-text">
              <span className="res-step-label">{step.label}</span>
            </div>
      ...
      <div className="res-main-layout">
        <aside className="res-sidebar">
          ...
          <div className="res-category-list">
            <div className="res-scroll-arrow res-top">
              <ChevronUp size={20} />
            </div>
            ...
            <div className="res-scroll-arrow res-bottom">
              <ChevronDown size={20} />
            </div>
          </div>
      ...
      <footer className="res-bottom-bar">
        <div className="res-action-btns">
          <button className="res-btn-cancel" onClick={handleCancelClick}>
            Cancel
          </button>
          <button
