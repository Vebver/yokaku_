        ...
        */}
        <div key={view} className="fade-in">
          ...
          {view === 'verify' ? (
            <VerifyEmail 
              email={email} 
              onVerify={(code) => { alert("Success!"); onClose(); }}
            ...
            <>
              ...
              <form onSubmit={view === 'login' ? (e) => e.preventDefault() : handleSignUpSubmit}>
                ...
                <button 
                  ...
                  disabled={password.length < 8 || (view === 'signup' && password !== confirmPassword)}
                >
