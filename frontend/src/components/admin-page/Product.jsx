    ...
    <div className="container-fluid p-4">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          ...
          <p className="text-muted">Manage what customers see on the digital menu</p>
        </div>
        <button className="btn btn-primary px-4 shadow-sm" data-bs-toggle="modal" data-bs-target="#addMenuModal">
                ...
                <tr key={item.item_id}>
                  <td className="ps-4">
                    <div className="d-flex align-items-center">
                      {item.image_url && (
                        <img src={item.image_url} alt="" className="rounded me-3" style={{ width: "45px", height: "45px", objectFit: "cover" }} />
                      )}
                      <div>
                        <div className="fw-bold">{item.name || "Unnamed Dish"}</div>
                  ...
                  <td>
                    <span className="badge bg-light text-dark border">{item.category_name || "Uncategorized"}</span>
                  </td>
                  <td className="fw-bold text-success">
                    ${item.price ? Number(item.price).toFixed(2) : "0.00"}
                  </td>
                  <td>
                    <span className={`badge ${item.is_available ? 'bg-success-subtle text-success' : 'bg-danger-subtle text-danger'} px-3`}>
            ...
            <form onSubmit={handleAddMenuItem}>
              <div className="modal-body px-4">
                ...
                <div className="mb-3">
                  ...
                  <textarea name="description" className="form-control" rows="2" value={newItem.description} onChange={handleInputChange}></textarea>
                </div>
                <div className="row">
                ...
                <div className="mb-3">
                  <label className="form-label small fw-bold">Upload Dish Image</label>
