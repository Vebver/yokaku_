            ...
            <>
              ...
              <div className="p-4 flex-grow-1 overflow-auto">
                ...
                {(() => {
                  ...
                  // Scan loaded orderItems to see if standard/premium packages were purchased
                  ...
                  return (
                    <div className="card border bg-white p-3 mb-3 rounded-3 shadow-sm text-dark animate-fade-in">
