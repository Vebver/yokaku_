      ...
      <div className="d-flex justify-content-between align-items-end mb-4">
        <div>
          ...
          <p className="text-muted small mb-0">
            Monitor bookings, orders, and payments
          </p>
        </div>
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="text-muted x-small">
                                ₱{Number(order.price).toFixed(2)} each
                              </div>
                              {customs && (
                  ...
                  <div className="d-flex justify-content-between align-items-center">
                    <div>
                      ...
                      <div className="fs-4 fw-bold">
                        ₱
                        {selectedRes.amount > 0
                          ? Number(selectedRes.amount).toLocaleString(
                              undefined,
                              { minimumFractionDigits: 2 },
                            )
                          : calculateDrawerTotal().toLocaleString(undefined, {
                              minimumFractionDigits: 2,
                            })}
                      </div>
                    </div>
                    <span
                      className={`badge ${selectedRes.payment_status === "verified" ? "bg-success" : "bg-warning"}`}
                    >
