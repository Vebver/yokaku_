...
import { 
  X, Upload, CheckCircle2, AlertCircle, ClipboardList, 
  CreditCard, Trash2, User, MapPin, Calendar, 
  Clock, Layers, Info, Mail, Phone 
} from "lucide-react";
import "../Style/ReservationSummary.css";

const ReservationSummary = ({ isOpen, onClose, orderSummary, reservationData, onConfirm, loading }) => {
  ...
  const displayTables = () => {
    ...
    const linked = reservationData.linkedTables?.length > 0 
  ...
  return (
    <div className="summary-modal-overlay" onClick={onClose}>
      <div className="summary-modal-content fade-in" onClick={(e) => e.stopPropagation()}>
        
        <header className="summary-header">
          <div className="header-title-group">
            <div className="icon-badge"><ClipboardList size={22} color="white" /></div>
        ...
        <div className="summary-body">
          ...
          <section className="summary-section">
            ...
            <div className="detail-grid full-info">
              <div className="detail-item">
                ...
                <span>{reservationData.firstName} {reservationData.lastName}</span>
              </div>
              <div className="detail-item">
              ...
              <div className="detail-item full-width">
                ...
                <span>Brgy. {reservationData.barangay}, {reservationData.municipality}</span>
              </div>
            </div>
          </section>
          ...
          <section className="summary-section">
            ...
            <div className="detail-grid full-info">
              ...
              <div className="detail-item">
                ...
                <span>{reservationData.startTime} - {reservationData.endTime}</span>
              </div>
              <div className="detail-item">
              ...
              <div className="detail-item full-width">
                ...
                <span className={reservationData.allergy !== "No Allergy" ? "allergy-active" : ""}>
          ...
          <section className="summary-section payment-box">
            <div className="section-header">
                ...
                <h3 style={{color: '#333', marginLeft: '8px', marginBottom: '0'}}>Payment Breakdown</h3>
            </div>
          ...
          <section className="summary-section">
            <label className="upload-instruction">
                Upload Gcash/Maya Receipt (Amount: ₱{orderSummary?.downpayment?.toFixed(2)})
            </label>
            <input 
              type="file" 
              ref={fileInputRef} 
            ...
            <div className="upload-container-wrapper">
                ...
                {receipt && (
                    <button type="button" className="remove-file-action" onClick={handleRemoveFile}>
                        <Trash2 size={18} />
                    </button>
                )}
            </div>
