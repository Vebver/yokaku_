...
import { UtensilsCrossed, ArrowRight, X, Link as LinkIcon, Calendar, Clock, Users, Info } from 'lucide-react';
...
export default function TableReservation({ onClose, onSuccess }) {
  ...
  const isFormInvalid = useMemo(() => {
    return !guestName.trim() || !resDate || !resTime || !guestCount || guestCount <= 0;
  }, [guestName, resDate, resTime, guestCount]);
