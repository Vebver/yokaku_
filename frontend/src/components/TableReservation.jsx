          ...
          <div className="floor-logo-bar">
            ...
            <div className="floor-header-text">
              ...
              <p className="floor-subtitle">
                Select a table to reserve your spot
              </p>
            </div>
          </div>
            ...
            <div className="tables-area">
              {TABLES_DATA.map((table) => {
                ...
                return (
                  <div
                    key={table.id}
                    className={`floor-table ${table.type} ${isSelected ? "selected" : isLinked ? "linked" : table.status}`}
        ...
        {!primaryTable ? (
          ...
          <div className="res-panel fade-in">
            ...
            >
              ...
              {linkedIds.length > 0 &&
                linkedIds.map((id) => {
                  ...
                  const isPrimaryRestricted = uncombinables.includes(
                    primaryTable.id,
                  );
                  ...
                  return (
                    <React.Fragment key={id}>
                      ...
                      {(isPrimaryRestricted || isLinkedRestricted) && (
                        ...
                        >
                          ({isPrimaryRestricted ? primaryTable.id : id} cannot
                          be combined to{" "}
                          {isPrimaryRestricted ? id : primaryTable.id})
                        </span>
                      )}
                    </React.Fragment>
                  );
                })}
              {(primaryTable.id === "T1" || primaryTable.id === "T10") &&
                linkedIds.length === 0 && (
                  <span
                    style={{
                      fontSize: "11px",
            ...
            <div className="panel-meta">
              <span>
                <Users size={14} /> {totalSeats} seats
              </span>
              <span>
                {primaryTable.type.includes("rect")
                  ? "Rect Table"
                  : "Square Table"}
              </span>
              {primaryTable.status !== "available" && (
                <span className="status-warning">
                  Already {primaryTable.status}
                </span>
              )}
            </div>
