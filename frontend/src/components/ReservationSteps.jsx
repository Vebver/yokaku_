// ReservationSteps.jsx (Updated - Removed Event Reservation step, no changes to Your Details)
...
export default function ReservationSteps({ onClose, onSuccess }) {
  ...
  // Event reservation specific state (preserved but not used in UI)
  ...
  const validateCurrentStep = () => {
    ...
    switch (currentStep) {
      ...
      case 2:
        if (isEventFlow) {
          // Your Details step for event flow (same validation as per_table)
  ...
  const renderStepContent = () => {
    ...
    switch (currentStep) {
      ...
      case 2:
        if (isEventFlow) {
          // Your Details step for event flow (same as original Your Details, no event fields added)
          return (
